...
const AlertIndicator = ({ severity }) => {
  ...
  return (
    <div className="relative flex-center">
      ...
      <div
        className={`absolute inset-0 rounded-full ${colors[severity]} animate-ping opacity-60`}
      ></div>
    </div>
  );
};
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <div className="space-y-6">
        <AnimatePresence>
          {alerts.length > 0 ? (
            alerts.map((alert, idx) => <AlertCard key={alert.id || idx} alert={alert} />)
          ) : (
            <motion.div
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-500 font-medium mt-2">
                  No active fraudulent triggers detected across the grid.
                </p>
              </div>
