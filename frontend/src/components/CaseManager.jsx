  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        <div
          className={`text-[10px] font-black px-2 py-1 rounded-lg uppercase tracking-widest border ${statusColors[caseData.status]}`}
        >
          {caseData.status}
        </div>
      ...
      <div className="space-y-1 mb-6">
        <div className="flex items-baseline gap-2">
          ...
          <span
            className={`text-[10px] font-bold uppercase tracking-widest ${riskColors[caseData.riskLevel]}`}
          >
          ...
          {filteredCases.length === 0 && (
            <div className="col-span-full glass-card p-20 rounded-[2rem] flex-center flex-col text-slate-600 border-dashed border-2 border-white/5">
              ...
              <p className="text-xs uppercase tracking-widest opacity-60">
                Adjust your filters to broaden the perimeter scan.
              </p>
            </div>
          )}
        </div>
            ...
            <div className="glass-card p-8 rounded-[2.5rem] border-white/5 relative overflow-hidden">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full py-4 rounded-2xl bg-white/5 border border-white/10 text-white font-black text-sm uppercase tracking-widest flex-center gap-2 hover:bg-white/10 transition-all">
