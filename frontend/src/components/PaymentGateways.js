...
const PaymentGateways = ({ account, contract }) => {
  ...
  const retryPayment = id => {
    ...
    setTimeout(() => {
      setTransactions(
        transactions.map(tx => (tx.id === id ? { ...tx, status: 'Success', date: 'Just now' } : tx))
      );
    }, 1500);
  };
      ...
      <header className="flex justify-between items-end mb-10">
        <div>
          ...
          <p className="text-slate-500 mt-2 font-medium">
            Manage multi-gateway payments and disbursements
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {methods.map(m => (
                  ...
                  >
                    <div
                      className={`p-3 rounded-xl ${selectedMethod === m.id ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-400'}`}
                    >
            ...
            <div className="relative z-10 flex flex-col sm:flex-row justify-between items-center gap-8">
              <div className="space-y-2">
                ...
                <p className="text-slate-400 text-sm max-w-xs">
                  Automated monthly reports for regulatory compliance and tax purposes.
                </p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 rounded-3xl p-8 border border-blue-100 space-y-4">
            ...
            <p className="text-xs text-blue-600 leading-relaxed font-medium">
              Our system automatically matches external payment processor records with blockchain
              transaction logs every 60 seconds.
            </p>
            <div className="flex items-center justify-between pt-4">
              ...
              <span className="text-[10px] font-black text-blue-300 uppercase letter-spacing-wide">
                Live Updates
              </span>
            </div>
          </div>
