...
const IssueCard = ({ issue, onApply, onContribute }) => {
  ...
  return (
    <div
      className={`issue-card ${getStatusColor(issue.status)} border rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg`}
    >
      <div className="p-6">
        {/* Header */}
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm text-gray-500">• {issue.totalApplications} applications</span>
        </div>
        ...
        {issue.requiredApprovals > 0 && (
          <div className="mb-4">
            <div className="flex justify-between text-sm text-gray-600 mb-2">
              ...
              <span>
                {issue.currentApprovals}/{issue.requiredApprovals}
              </span>
            </div>
