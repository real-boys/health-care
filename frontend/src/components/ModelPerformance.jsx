...
import { Target, TrendingUp, Sliders, RefreshCcw, Brain, Cpu, Zap, Activity } from 'lucide-react';
import {
  LineChart,
  Line,
  XAxis,
...
const MetricBadge = ({ label, value, desc, delay }) => (
  ...
  >
    <p className="text-4xl font-black text-white tracking-tighter mb-1 glow-text-indigo">
      {value.toFixed(1)}%
    </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-rose-500 font-black">
                  {Math.floor(15420 * (1 - threshold) * (1 - precision / 100))}
                </span>
              </div>
            </div>
          </div>
