        ...
        {prescriptions.map((prescription, idx) => (
          ...
          >
            <div className="flex items-center gap-6">
              <div
                className={`p-5 rounded-2xl ${prescription.status === 'Active' ? 'bg-blue-50 text-blue-600' : 'bg-slate-50 text-slate-400'} group-hover:scale-110 transition-transform`}
              >
              ...
              <div>
                ...
                <div className="flex items-center gap-4 text-sm text-slate-500">
                  <span className="flex items-center gap-1.5">
                    <Clock className="w-4 h-4" /> {prescription.frequency}
                  </span>
                  <span className="flex items-center gap-1.5">
                    <FileText className="w-4 h-4" /> {prescription.dosage}
                  </span>
                </div>
