        ...
        {metrics.map((metric, idx) => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div
                className={`p-4 ${metric.bg} ${metric.color} rounded-2xl group-hover:scale-110 transition-transform`}
              >
              ...
              <div className="flex items-center gap-1">
                ...
                <span
                  className={`text-xs font-bold uppercase tracking-wider ${metric.trend === 'up' ? 'text-red-500' : metric.trend === 'down' ? 'text-blue-500' : 'text-slate-400'}`}
                >
                  {metric.trend}
                </span>
              </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">
                We'll notify you if any vitals fall outside your normal range.
              </p>
            </div>
          </div>
